...
public record UserCreatedEvent(
    ...
    public static UserCreatedEvent of(UUID userId, String username, String email, UserStatus status, String role) {
        return of(userId, username, email, status, role, UUID.randomUUID());
    }

    public static UserCreatedEvent of(UUID userId, String username, String email, UserStatus status, String role, UUID eventId) {
